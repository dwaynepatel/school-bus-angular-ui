...
export class JourneyEditComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.sub = this.route.paramMap.subscribe(params => {
      ...
      // i add another variable to keep track of the bus company around the view screens i.e JourneyId
      const id = params.get('journeyId');
      if (id) {
